<template>
  <div class="container">
    <h2 class="homeTitle">
      ...
      菜品总览
      <span class="detail-link"><router-link to="dish">菜品管理 →</router-link></span>
    </h2>
  ...
  ul {
    ...
    li {
      ...
      &.card-open {
        ...
        border-left-color: #98E4C6;
      }

      &.card-stop {
        background: linear-gradient(135deg, #F5F5FA 0%, #EEEEF5 100%);
        border-left-color: #C5C5D2;
      }

      &.add {
        width: 100px;
        flex: none;
        background: linear-gradient(135deg, #FF8BA7 0%, #C3A6FF 100%);
        border-radius: 14px;
        text-align: center;
        color: #fff;
        ...
        i {
          ...
          height: 28px;
          margin: 0 auto;
          background: url(@/assets/icons/btn_add@2x.png) no-repeat;
